...
(function($) {
    ...
    Datepicker.prototype = {
        ...
        fillMonth: function() {
            ...
            var maxDateValueInstance = this.settings.maxDateInstance;
            var minDateValueInstance = this.settings.minDateInstance;
            ...
            monthArray.forEach(function(rows) {
                ...
                rows.data.forEach(function(col, colIndex) {
                    var dateValueInstance = new Date(col.dateValue);
                    ...
                    if (!col.isCurrentMonth || (maxDateValueInstance && dateValueInstance > maxDateValueInstance) || (minDateValueInstance && dateValueInstance < minDateValueInstance)) {
            ...
            if(this.settings.dayLabels && this.settings.dayLabels.length == 7){
                this.$datepickerEl.find('#Monday').children().attr('title', (this.settings.dayLabels[0].full));
                this.$datepickerEl.find('#Monday').children().text(this.settings.dayLabels[0].abbv);
                this.$datepickerEl.find('#Tuesday').children().attr('title', (this.settings.dayLabels[1].full));
                this.$datepickerEl.find('#Tuesday').children().text(this.settings.dayLabels[1].abbv);
                this.$datepickerEl.find('#Wednesday').children().attr('title', (this.settings.dayLabels[2].full));
                this.$datepickerEl.find('#Wednesday').children().text(this.settings.dayLabels[2].abbv);
                this.$datepickerEl.find('#Thursday').children().attr('title', (this.settings.dayLabels[3].full));
                this.$datepickerEl.find('#Thursday').children().text(this.settings.dayLabels[3].abbv);
                this.$datepickerEl.find('#Friday').children().attr('title', (this.settings.dayLabels[4].full));
                this.$datepickerEl.find('#Friday').children().text(this.settings.dayLabels[4].abbv);
                this.$datepickerEl.find('#Saturday').children().attr('title', (this.settings.dayLabels[5].full));
                this.$datepickerEl.find('#Saturday').children().text(this.settings.dayLabels[5].abbv);
                this.$datepickerEl.find('#Sunday').children().attr('title', (this.settings.dayLabels[6].full));
                this.$datepickerEl.find('#Sunday').children().text(this.settings.dayLabels[6].abbv); 
            }
        },
        ...
        getMonthArray: function() {
            ...
            var testDatee=new Date(viewedYear, viewedMonth, 1);
            ...
            // Fill previous month
                ...
                //for (var i = firstDayOfMonth == 0 || firstDayOfMonth == 7 ? numDaysInPrevMonth - ((new Date(viewedYear, viewedMonth, 1)).getDay() + 1) : numDaysInPrevMonth - ((new Date(viewedYear, viewedMonth, 1)).getDay() - 2); i <= numDaysInPrevMonth; i++) {

                for (var i = firstDayOfMonth == 0 || firstDayOfMonth == 7 ? numDaysInPrevMonth - 5 : numDaysInPrevMonth - ((new Date(viewedYear, viewedMonth, 1)).getDay() - 2); i <= numDaysInPrevMonth; i++) {
        ...
        clickPrev: function(e) {
            ...
            if (self.viewedMonth === 0) {
                ...
                self.viewedYear--;
                var $yearSelect = this.$datepickerEl.find('select');
                $yearSelect.val(self.viewedYear);
            } else {
                self.viewedMonth--;
            }
